...
export default function FutureEvents({ data, loading }: FutureEventsProps) {
  // TODO: Once the timezone from that event's country has passed the start time or equals to the "endDateTime", put it to the previous
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          {data.length <= 0 ? (
            <p className="text-white font-2xl font-bold">
              You have not picked any events to go to
            </p>
          ) : (
            <>
