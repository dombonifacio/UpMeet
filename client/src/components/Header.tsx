...
{/* <div className="text-white flex flex-row justify-between w-[600px] mt-2 bg-gray-900 p-5">
    ...
    <Link to={'/'} className='text-indigo-300 text-lg hover:text-indigo-500'>Home</Link>
      <Link to={'/profile'} className='text-indigo-300 text-lg hover:text-indigo-500'>Profile</Link>
        ...
        <button onClick={logout} className='text-indigo-300 text-lg hover:text-indigo-500'>Log out</button>
    </div>
